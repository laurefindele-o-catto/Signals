...
def choose_transform_length(len_a, len_b, engine):
    ...
    # need =
    # return
    raise NotImplementedError("TODO 1: a length with one slot per lag")
...
def cross_correlate(a, b, engine):
    ...
    raise NotImplementedError("TODO 2: cross-correlation through the spectrum")
...
def find_shift(text_a, text_b, method):
    ...
    raise NotImplementedError("TODO 3: locate the peak and unwrap it")
